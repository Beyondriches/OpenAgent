    ...
    <section style={styles.card}>
      ...
      {history?.status === "Eligible" && previous ? (
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "14px" }}>
              <caption style={{ textAlign: "left", color: "#94a3b8", paddingBottom: "10px" }}>
                {`Current analysis compared with the newest saved snapshot that is at least ${data?.timeframe === "day" ? "one hour" : data?.timeframe === "swing" ? "24 hours" : "7 days"} older.`}
              </caption>
              <thead>
                <tr>
        ...
        <p style={styles.paragraph}>
          ...
          {`No snapshot at least ${data?.timeframe === "day" ? "one hour" : data?.timeframe === "swing" ? "24 hours" : "7 days"} older is available for this asset and mode yet. Current analysis still works, but history contributes 0 points until an eligible comparison exists.`}
        </p>
      )}
    </section>
  );
